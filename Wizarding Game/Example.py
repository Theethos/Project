...
def game():
    ...
    try:
        Bird.image.append(pygame.image.load(os.path.join("Wizarding Game","Image","200x200","babytux.png")))
        Bird.image.append(pygame.image.load(os.path.join("Wizarding Game","Image","200x200","babytux_neg.png")))
    except:
